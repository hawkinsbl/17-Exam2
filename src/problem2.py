...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        s = 1/2*(self.a.distance_from(self.b)+self.a.distance_from(self.c)+self.c.distance_from(self.b))
        return math.sqrt(s*(s-self.a.distance_from(self.b))*(s-self.b.distance_from(self.c))*(s-self.c.distance_from(self.a)))
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        triangle = Triangle(self.a.clone(),self.b.clone(),self.c.clone())
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(40, 50)
    expected_b = Point(60, 20)
    expected_c = Point(0, 100)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
